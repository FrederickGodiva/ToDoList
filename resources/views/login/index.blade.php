<x-main>
    ...
    <form action="" method="post" class="mt-3 flex flex-col gap-4">
        ...
        <div class="flex flex-col">
            ...
            <input type="text" name="username" id="username" placeholder="username" class="py-1 px-2 rounded-md border-slate-200 border-2 outline-none rounded-md focus:ring-blue-500 focus:ring-2 ring-blue-500">
        </div>
